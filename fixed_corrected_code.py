...
def process_features_consistently(df, encoders=None, is_train=True):
    ...
    if is_train:
        ...
        for col in cat_cols:
            ...
            # Ensure 'missing' and 'unknown' are always in the vocabulary
        ...
        for col in cat_cols:
            if col in encoders:
                ...
                def safe_transform(x):
                    ...
                    elif 'unknown' in encoders[col].classes_:
                        return encoders[col].transform(['unknown'])[0]
                    elif 'missing' in encoders[col].classes_:
                ...
                # If column doesn't exist in encoders, set to 0
                df[col] = 0
